...
![Board Close-Up](images/board-close.jpg)
...
While this design runs the ADC at 3.3V, it can be used with the technique in the [AN013 Tracker GPIO](https://docs.particle.io/hardware/tracker/projects/tracker-gpio/) application note use an I2C level shifter and run the ADC at 5V, allowing full 5V analog inputs.
